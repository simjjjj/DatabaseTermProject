...
<div class="container mx-auto px-6 py-12">
  <?php if ($petition): ?>
    <h2 class="text-3xl font-bold mb-6 text-gray-900 dark:text-gray-200"><?php echo htmlspecialchars($petition['title']); ?></h2>
    ...
    <h3 class="text-2xl font-bold mb-4 text-gray-900 dark:text-gray-200">댓글</h3>
    <?php if ($comments): ?>
